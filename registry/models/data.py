...
class DataStandard(TimeStampedModel):
    ...
    infrastructure_reference_documents = models.ManyToManyField(InfrastructureReferenceDocument, related_name='data_standards')

    def __str__(self):
        return self.name


class DataExchangeFormat(TimeStampedModel):
    name = models.CharField(max_length=255, unique=True)
    description = models.TextField(null=True)
    version = models.CharField(max_length=50, null=True)
    ...
    infrastructure_reference_documents = models.ManyToManyField(InfrastructureReferenceDocument, related_name='data_exchange_formats')
