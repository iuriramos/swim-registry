...
class ReferenceDocument(DocumentModel):
    document = models.FileField(upload_to = 'swim/reference_documents/', blank=False)
...
class InfrastructureReferenceDocument(DocumentModel):
    document = models.FileField(upload_to = 'infrastructure/reference_documents/', blank=False)
...
#     document = models.FileField(upload_to = 'swim/documents/', blank=False)
...
class InfrastructureDescriptionDocument(DocumentModel):
    document = models.FileField(upload_to = 'infrastructure/documents/infrastructure_description/', blank=False)
...
class DataExchangeFormatServiceDocument(DocumentModel):
    document = models.FileField(upload_to = 'infrastructure/data_exchange_formats/documents/services/', blank=False)
...
class DataExchangeFormatApplicationDocument(DocumentModel):
    document = models.FileField(upload_to = 'infrastructure/documents/data_exchange_formats/applications/', blank=False)
...
class TechnicalInterfaceDocument(DocumentModel):
    document = models.FileField(upload_to = 'services/technical_interfaces/documents/', blank=False)
...
class ServiceDocument(DocumentModel):
    document = models.FileField(upload_to = 'services/documents/', blank=False)
...
class ApplicationDocument(DocumentModel):
    document = models.FileField(upload_to = 'applications/documents/', blank=False)
...
class ParticipantDocument(DocumentModel):
    document = models.FileField(upload_to = 'participants/documents/', blank=False)
