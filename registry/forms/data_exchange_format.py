...
DataExchangeFormatServiceFormSet = inlineformset_factory(
    ...
    widgets = {
        'name': forms.widgets.TextInput(attrs={'id': 'id_data_exchange_format_services-name', 'class': 'form-control', 'placeholder': _('Data exchange format name')}),
        'description': forms.widgets.Textarea(attrs={'id': 'id_data_exchange_format_services-description', 'class': 'form-control', 'placeholder': _('Data exchange format description')}),
        'version': forms.widgets.TextInput(attrs={'id': 'id_data_exchange_format_services-version', 'class': 'form-control', 'placeholder': _('Data exchange format version')}),
